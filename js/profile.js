...
// The mascots as FULL die-cut stickers (character + name plaque). Everyone may
// pick one — kids, grown-ups and teens all get the whole sticker, same as the
// kid tiles; the avatar tile just contains it.
const MASCOTS_FULL = [
