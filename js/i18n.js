...
const STRINGS = {
  ...
  lesson: {
    ...
    checkpointTitle: "Partea {n} din {total} — gata!",
    checkpointSub: "Ai făcut {done} din {total} de întrebări. Continui sau te oprești?",
    checkpointContinue: "Continuă (încă 10)",
    checkpointStop: "Oprește-te aici",
    checkpointStopHint: "Progresul e salvat — data viitoare continui de unde ai rămas.",
  ...
  home: {
    ...
    greeting: "Salut, {name}! 👋",
    greetingSub: "Hai să învățăm azi!",
    progressHeading: "Progresul tău",
    tileWords: "cuvinte știute",
    tileLessons: "lecții",
    tileStreak: "serie",
